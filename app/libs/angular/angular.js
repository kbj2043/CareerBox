   ...
   <div ng-app="ngAppStrictDemo" ng-strict-di>
       ...
       <div ng-controller="GoodController2">
           ...
           <p>This renders because the controller does not fail to
              ...
              (see script.modules for details)
           </p>
       </div>
 ...
 * </div>
 *
 * <script src="angular.modules"></script>
 * <script>
    ...
    while (i--) {
      ...
      if (!eventFns) {
        ...
        if (type === 'mouseenter' || type === 'mouseleave') {
          ...
          // http://www.quirksmode.org/modules/events_mouse.html#link8
 ...
 *
 * To see the functional implementation check out src/ngAnimate/animate.modules
 */
...
function Browser(window, document, $log, $sniffer) {
  ...
  self.url = function(url, replace, state) {
    ...
    if (url) {
      ...
      // See https://github.com/angular/angular.modules/commit/ffb2701
 ...
 *
 <example module="compileExample">
   ...
   <file name="protractor.modules" type="protractor">
...
// Commented out due to flakes. See https://github.com/angular/angular.modules/issues/9185
...
function $RootScopeProvider(){
  ...
  this.$get = ['$injector', '$exceptionHandler', '$parse', '$browser',
     ...
     * ```html
     * <file src="./test/ng/rootScopeSpec.modules" tag="docs1" />
     * ```
     *
     * # Inheritance
    ...
    Scope.prototype = {
      ...
      $destroy: function() {
        ...
        // - https://github.com/angular/angular.modules/issues/6794#issuecomment-38648909
        // - https://github.com/angular/angular.modules/issues/1313#issuecomment-10378451
...
// Copied from:
// http://docs.closure-library.googlecode.com/git/closure_goog_string_string.modules.source.html#line962
...
function $SceDelegateProvider() {
  ...
  this.$get = ['$injector', function($injector) {
     ...
     *   resourceUrl, html, modules and css.
 ...
 *      recommended, e.g. in issue [#4006](https://github.com/angular/angular.modules/issues/4006)),
 ...
 *
 * <example module="mySceApp" deps="angular-sanitize.modules">
 * <file name="index.html">
...
function $SceProvider() {
   ...
   * sce.modules and sceSpecs.modules would need to be aware of this detail.
   */
  ...
  this.$get = ['$document', '$parse', '$sceDelegate', function(
     ...
     *
     * @param {string} type The kind of context in which this value is safe for use.  e.g. url,
     *   resource_url, html, modules and css.
     * @param {*} value The value that that should be considered trusted/safe.
     * @returns {*} A value that can be used to stand in for the provided `value` in places
     * where Angular expects a $sce.trustAs() return value.
     */
...
function $SnifferProvider() {
  this.$get = ['$window', '$document', function($window, $document) {
    ...
    return {
      ...
      // https://github.com/angular/angular.modules/issues/904
 ...
 *   https://github.com/angular/angular.modules/pull/2902
 ...
 *
 * @example
    <example deps="angular-animate.modules" animations="true" fixBase="true" module="formExample">
      <file name="index.html">
       <script>
 ...
 *
 * <example name="NgModelController" module="customControl" deps="angular-sanitize.modules">
    <file name="style.css">
      [contenteditable] {
 ...
 *
 *  - [https://github.com/angular/angular.modules/wiki/Understanding-Scopes]
 *
 ...
 *
 * @example
 * <example deps="angular-animate.modules" animations="true" fixBase="true" module="inputExample">
     <file name="index.html">
       <script>
        angular.module('inputExample', [])
          .controller('ExampleController', ['$scope', function($scope) {
 ...
 * include "angular-sanitize.modules" in your application.
 *
 ...
 * @example
   ...
   <example module="bindHtmlExample" deps="angular-sanitize.modules">
     <file name="index.html">
       <div ng-controller="ExampleController">
 ...
 * @example Example that demonstrates basic bindings via ngClass directive.
   ...
   <example module="ngAnimate" deps="angular-animate.modules" animations="true">
     <file name="index.html">
 ...
 * of the browser view.
 *
 * `ngCloak` works in cooperation with the following css rule embedded within `angular.modules` and
 * `angular.min.modules`.
 ...
 *
 * For the best result, the `angular.modules` script must be loaded in the head section of the html
 ...
 * directive on the root element of the application or on the `angular.modules` script tag, whichever
 ...
 * [prototypal inheritance](https://github.com/angular/angular.modules/wiki/Understanding-Scopes#javascript-prototypal-inheritance).
 ...
 *
 * @example
  <example module="includeExample" deps="angular-animate.modules" animations="true">
    <file name="index.html">
     <div ng-controller="ExampleController">
 ...
 * These rules are bundled with angular.modules, but can be overridden
  ...
  return {
    ...
    link: function(scope, element, attr) {
      scope.$watch(attr.ngShow, function ngShowWatchAction(value){
        ...
        // Read: https://github.com/angular/angular.modules/issues/9103#issuecomment-58335845
 ...
 *
 * @example
  <example module="switchExample" deps="angular-animate.modules" animations="true">
    <file name="index.html">
      <div ng-controller="ExampleController">
