...
define([
    ...
    app.controller('editorController', ['$scope', '$http', 'httpLogout', 'serverURL', 'SavePaper', 'memberCallback', function ($scope, $http, httpLogout, serverURL, SavePaper, memberCallback) {
        //member
        $scope.errors = [];
        $scope.msgs = [];
